...
const ALL_ROUTES = ['/', '/plan', '/split', '/workout', '/insights', '/history', '/goals', '/coach', '/exercises', '/profile', '/partners', '/profile?view=settings', '/profile?view=appearance', '/profile?view=billing', '/profile?view=devices', '/profile?view=faq', '/profile?view=coach', '/profile?view=connections'];
