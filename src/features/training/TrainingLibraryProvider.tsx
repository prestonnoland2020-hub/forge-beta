...
export const starterExercises:LibraryExercise[]=[
  ...
  /* AND PULL UPS ARE A PRIMARY LIFT, not a CrossFit movement. The row carried
     `detail: 'CrossFit · repetitions'` and no categories, so the category was
     derived as CrossFit alone and isProgrammableStrength refused it — which
     meant one of the four lifts a strength program is actually measured by
     could not be chosen as a goal, could not be mapped to a back day, and did
     not appear in the goal picker at all. Preston logs them with a belt on
     (130 x 2) and has done for months. Deadlift already carried both
     categories for the same reason; this is the same fix. */
