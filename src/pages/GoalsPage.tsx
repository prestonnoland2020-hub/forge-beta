...
export function GoalsPage(){
  ...
  return <div className="stack-xl goals-workspace goals-single-page"><PageIntro eyebrow="TRAINING OUTCOMES" title="Goals" copy="Set the outcome, then track the simplest useful estimate from completed work." action={<button className="button" onClick={()=>openBuilder()}>＋ New goal</button>}/>
