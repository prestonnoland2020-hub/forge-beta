...
export function InsightsPage(){
  ...
  return <div className="stack-xl insights-pro"><PageIntro eyebrow="INSIGHTS" title="See what is changing" copy="Completed workouts, comparable measurements, and training frequency in one place."/>
