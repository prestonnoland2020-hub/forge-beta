...
function WorkoutEditor() {
  ...
  const quickLogTopSet=(set:LoggedTopSet)=>{if(!set.lift||!set.weight||!set.reps)return;if(!dayLabel){setQuickLogMessage(noDayReason);return}const completed={...set,completed:true,calculatedMax:calculateEstimatedOneRepMax(set.weight,set.reps)??undefined};const primary=liftPrimary(set.lift);/* A DAY IS NAMED AFTER THE SPLIT DAY IT IS, NOT THE FIRST LIFT ON IT. Saving
